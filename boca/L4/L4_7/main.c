...
int ComparaQuadrante(tReta reta);
...
int main()
{
    ...
    for (i = 1; i <= n; i++)
    {
        ...
        quadrante = ComparaQuadrante(reta);

        ImprimeResultado(quadrante);
    }
...
int ComparaQuadrante(tReta reta)
{
    ...
    quadrante1 = IdentificaQuadrante(reta.pi);
    quadrante2 = IdentificaQuadrante(reta.pf);

    if (quadrante1 == quadrante2 && quadrante1 != 0)
    {
        return 1;
    }
    else
